...
In Chapter~\ref{chp:ch6-object} we demonstrate a noval technique that generalizes the existing approach of modeling object in dynamic languages on the JVM.
