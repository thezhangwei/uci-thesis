...
In summary, list comprehension desugaring eliminates the performance introduced by the concise syntax of list comprehension, and enables efficient list creation in ZipPy.
