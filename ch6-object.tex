...
This technique, inspired by previous research on virtual machines~\cite{Deutsch1984, holzle1991, Brunthaler2010inca}, amortizes the cost of accessing the same attribute on the Python objects of the same type.
...
The dispatch node performs the actual call using an inline caching inspired dispatch chain~\cite{Deutsch1984, holzle1991}, and passes all the arguments to the AST of the callee.
