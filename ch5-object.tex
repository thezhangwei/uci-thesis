...
We address this issue by turning the zombie object storage to a proxy to the flexible storage object it migrates to.
...
As a proxy the zombie redirect all attribute accesses to the flexible object storage.
...
\fxnote{talk about layout and storage class stabilization before JIT compilation}
