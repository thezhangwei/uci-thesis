...
The \texttt{PythonCallNode} organizes different components of the call site and handles transformations like specialization and de-optimization at runtime.

\subsection{Call Node Specializations}

Similar to type specializations we discussed in Chapter~\ref{chp:ch3-zippy}, we construct call nodes initially in the uninitialized version.


\begin{figure}
\centering
\includegraphics[scale=.49]{figures/ch5-call-node-specialization-simple}
\caption{Call node specialization for a simple call site}
